...
const GradientButton = ({text}: Props) => {
  return (
    <div
    className='text-center transition-all ease-in-out hover:text-lg'
    ...
    <span className="text-center relative text-black font-light hover:text-lg transition-all ease-in-out">{text}</span>
    </a></div>
  )
}
